...
ax.set_title(r'Dai et al.',fontsize=8)
# ax.set_ylim([60,6000])
...
path=f'USSCI/figures/'+args.date+'/Dai-2020'
os.makedirs(path,exist_ok=True)
plt.savefig(path+f'/Mixture2.png', dpi=500, bbox_inches='tight')
toc = time.time()
print(f'Simulation completed in {toc-tic}s and stored at {path}/Mixture2.png\n')
