...
title=f'Flow Reactor: 890ppm NH3/10% O2/N2 ({P}atm, {T}K)'
...
ax[0].legend(fontsize=lgdfsz-1,frameon=False,loc='best', handlelength=lgdw,ncol=1,bbox_to_anchor=(-0.2,1.1)) 
ax[1].legend(fontsize=lgdfsz-1,frameon=False,loc='best', handlelength=lgdw,ncol=1,bbox_to_anchor=(1.05,1.1)) 
