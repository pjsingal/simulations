...
dataset=pd.read_csv(path+f'A1_data.csv',header=None)
ax.plot(dataset.iloc[:,0],dataset.iloc[:,1],linewidth=lw,color='xkcd:purple',label='A*1',zorder=100)

dataset=pd.read_csv(path+f'A3_data.csv',header=None)
ax.plot(dataset.iloc[:,0],dataset.iloc[:,1],linewidth=lw,color='xkcd:grey',label='A*3',zorder=100)

dataset=pd.read_csv(path+f'A5_data.csv',header=None)
ax.plot(dataset.iloc[:,0],dataset.iloc[:,1],linewidth=lw,color='xkcd:teal',label='A*5',zorder=100)

dataset=pd.read_csv(path+f'A10_data.csv',header=None)
ax.plot(dataset.iloc[:,0],dataset.iloc[:,1],linewidth=lw,color='orange',label='A*10',zorder=100)

dataset=pd.read_csv(path+f'A20_data.csv',header=None)
ax.plot(dataset.iloc[:,0],dataset.iloc[:,1],linewidth=lw,color='r',label='A*20',zorder=100)
...
path="PCI-ESSCI\\figures\\Flame Speed Plots\\"
if save_plots == True:
