...
plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_epsNH3_T=300K.yaml",r"$\epsilon_{0,NH_3}(300K)$","xkcd:teal",zorder_value=82)
plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_epsNH3_T=2000K.yaml",r"$\epsilon_{0,NH_3}(2000K)$","orange",zorder_value=81)
plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_LMRR_allAR.yaml","Ar","r",zorder_value=70)
plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_LMRR_allH2O.yaml",r'$\rm H_2O$',"b",zorder_value=80)
# plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_LMRR.yaml","LMR-R","xkcd:purple",zorder_value=100)
plotXvsTime("chemical_mechanisms/Alzueta-2023/alzuetamechanism_LMRR_extraColliders.yaml","LMR-R","xkcd:purple",zorder_value=100)
